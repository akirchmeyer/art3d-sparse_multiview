...
def mae_vit_base_patch16_dec512d8b(checkpoint, **kwargs):
...
def mae_vit_large_patch16_dec512d8b(checkpoint, **kwargs):
    model = MaskedAutoencoderViT(
...
def mae_vit_huge_patch14_dec512d8b(checkpoint, **kwargs):
    model = MaskedAutoencoderViT(
